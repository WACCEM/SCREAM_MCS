#!/bin/bash
#
# Remap MRMS 3D reflectivity data to 4-km MergedIR grid using conservative remapping
#
# Usage: ./remap_mrms_to_mergedir.sh <mrms_file>
#
# Example:
#   ./remap_mrms_to_mergedir.sh MRMS_MergedReflectivityQC_L33_20250930-223040.nc
...
# Input directory
in_dir='/pscratch/sd/i/iclas2/meng/mrms/conus_2021_netcdf/MRMS_MergedReflectivityQC_L33/'
...
# Define weight file
map_conserve='/pscratch/sd/w/wcmca1/SCREAMv1-cess2/maps/MRMS_to_MergedIR_conserve.nc'
...
out_file="${out_dir}/MRMS_Reflectivity_MergedIR_${timestamp}.nc"

echo "========================================================================"
echo "MRMS to MergedIR Remapping"
echo "========================================================================"
echo "Input file:"
echo "  MRMS:          $mrms_file"
echo ""
...
# Step 1: Remap MRMS reflectivity to MergedIR grid using conservative method
echo ""
echo "Step 1: Remapping MRMS reflectivity to MergedIR grid..."
step1_start=$(date +%s)
