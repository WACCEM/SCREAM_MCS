...
for the IMERGv7 tracking run.

Outputs written to the same directory as this script:
  tasklist_mcs_monthly_rainmap_IMERGv7.txt
  slurm.submit_mcs_monthly_rainmap_IMERGv7.sh
...
Usage examples:
  ...
  # Custom range
  python gen_imerg_mcs_monthly_stats_taskfarmer.py --start-date 2000-01 --end-date 2002-12
...
# Output filenames
TASKLIST_FNAME = "tasklist_mcs_monthly_rainmap_IMERGv7.txt"
SLURM_FNAME    = "slurm.submit_mcs_monthly_rainmap_IMERGv7.sh"

# Per-year config filename pattern
CONFIG_BASENAME = "config_mcs_tbpf_IMERGv7_mcsmip_{year}.yml"
...
def write_slurm(path, tasklist_path, nodes, threads, qos, walltime):
    ...
    content = f"""\
#!/bin/bash
#SBATCH --job-name=MonRainIMERGv7
#SBATCH -A m1867
...
#SBATCH --exclusive
#SBATCH --output=logs/log_mcs_monthly_rainmap_IMERGv7.log
