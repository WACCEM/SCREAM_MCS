#!/usr/bin/env python
"""
Generate SCREAM decadal MCS tracking config YAML files and Slurm job scripts
from templates, with an option to submit the Slurm jobs.

Usage examples:
    # Write both config + slurm files for default year range (1995–2005)
    ...
    python gen_scream_tracking_scripts.py --no-write_slurm
...
# INPUT_DATA_DIR = "/global/cfs/cdirs/e3smdata/simulations/scream-decadal/MCS/input4tracking/ne1024"
# INPUT_DATA_DIR = "/global/cfs/cdirs/e3smdata/simulations/scream-decadal/MCS/input4tracking/ne256/01"
INPUT_DATA_DIR = "/global/cfs/cdirs/e3smdata/simulations/scream-decadal/MCS/input4tracking/ne256/03"
...
# Template file paths
# CONFIG_TEMPLATE = os.path.join(SCRIPT_DIR, "config_mcs_tbpf_SCREAM_decadal_template.yml")
# SLURM_TEMPLATE  = os.path.join(SCRIPT_DIR, "slurm_mcs_SCREAM_decadal_template.sh")
# CONFIG_TEMPLATE = os.path.join(SCRIPT_DIR, "config_mcs_tbpf_SCREAM_ne256_ctl_template.yml")
# SLURM_TEMPLATE  = os.path.join(SCRIPT_DIR, "slurm_mcs_SCREAM_ne256_ctl_template.sh")
CONFIG_TEMPLATE = os.path.join(SCRIPT_DIR, "config_mcs_tbpf_SCREAM_ne256_tune_template.yml")
SLURM_TEMPLATE  = os.path.join(SCRIPT_DIR, "slurm_mcs_SCREAM_ne256_tune_template.sh")

# Output file name patterns (without year or extension, which are added later)
# CONFIG_BASENAME = "config_mcs_tbpf_SCREAM_decadal_"
# SLURM_BASENAME  = "slurm_mcs_SCREAM_decadal_"
# CONFIG_BASENAME = "config_mcs_tbpf_SCREAM_ne256_ctl_"
# SLURM_BASENAME = "slurm_mcs_SCREAM_ne256_ctl_"
CONFIG_BASENAME = "config_mcs_tbpf_SCREAM_ne256_tune_"
SLURM_BASENAME = "slurm_mcs_SCREAM_ne256_tune_"
...
# FILE_PREFIX = "output.scream.decadal.1hourlyINST_ne1024pg2.INSTANT.nhours_x1."
FILE_PREFIX = "1hi.INSTANT.nhours_x1."
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Generate SCREAM decadal MCS tracking config YAML and Slurm job scripts "
    ...
    parser.add_argument(
        ...
        type=int,
        default=1995,
        help="First year to process (default: 1995)",
    )
    parser.add_argument(
        "--end-year",
        type=int,
