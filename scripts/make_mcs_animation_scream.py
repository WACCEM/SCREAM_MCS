...
config_file = f"/global/homes/f/feng045/program/scream/config/config_mcs_tbpf_SCREAMv1-Cess2.yml"
...
# title_prefix = 'GPM Tb+IMERGv07'
title_prefix = 'SCREAM Cess2 Tb+PF'
...
# Subset domain before plotting (0: full domain, 1: subset domain defined by lon/lat limits)
subset = 1
...
plotting_code = script_dir + script_mapping[(plot_type, data_type)]
...
if data_type == "tbpf":
    ...
    figdir = f"/global/cfs/cdirs/m1867/zfeng/E3SM/SCREAMv1/cess2/{region}/quicklooks_{plot_type}_{data_type}/{start_year}/"
    animation_dir = f"/global/cfs/cdirs/m1867/zfeng/E3SM/SCREAMv1/cess2/{region}/animations_{plot_type}_{data_type}/"
elif data_type == "tbze":
