...
# Script parameters
# SCREAM
# start_date = "2020-07-13T00:00"
# end_date = "2020-07-16T00:00"
# MRMS
start_date = "2025-08-01T00:00"
end_date = "2025-08-15T00:00"
...
# lat_max = radar_lat + 4
# Phoenix region
lon_min = radar_lon - 4.0
lon_max = radar_lon + 4.0
lat_min = radar_lat - 2.5
lat_max = radar_lat + 2.5

# Get start year from start_date
start_year = str(start_date.split('-')[0])

# Tracking config file
# config_file = f"/global/homes/f/feng045/program/scream/tracking/config_celltracking_3km_SCREAMv1-Cess2_CONUS_07.yaml"
config_file = f"/global/homes/f/feng045/program/scream/tracking/jobs/config_celltracking_3km_MRMS_202508.yaml"
...
show_city = True         # Overplot city locations as filled diamonds
show_nexrad = True        # Overplot NEXRAD locations as filled circles
nexrad_radius = 150       # NEXRAD range circle radius in km (0 = no circle)
# Font sizes
...
# Output directories
# SCREAM
# figdir = f"/global/cfs/cdirs/m1657/zfeng/SCREAMv1-cess2/cell_conus/quicklooks_phoenix/"
# animation_dir = f"/global/cfs/cdirs/m1657/zfeng/SCREAMv1-cess2/cell_conus/animations_phoenix/"
# MRMS
figdir = f"/global/cfs/cdirs/m1657/zfeng/MRMS/cell_conus/quicklooks_phoenix/"
animation_dir = f"/global/cfs/cdirs/m1657/zfeng/MRMS/cell_conus/animations_phoenix/"
...
# script_dir = "/global/homes/f/feng045/program/PyFLEXTRKR-dev/Analysis/"
script_dir = "./"

print("Make cell tracking animation")
print(f"Plotting script: {script_dir}plot_subset_cell_tracks_terrain.py")
...
if run_plotting:
    ...
    cmd = [
        'python', f'{script_dir}plot_subset_cell_tracks_terrain.py',
        '--start', start_date,
        '--end', end_date,
        '--config', config_file,
    ]
    ...
    cmd.extend(['--show_city', str(int(show_city))])
    cmd.extend(['--show_nexrad', str(int(show_nexrad))])
    cmd.extend(['--nexrad_radius', str(nexrad_radius)])
